export const GREETINGS = [
  { language: 'English', hello: 'Hey' },
  { language: 'Old English', hello: 'Wes hāl' },
  { language: 'Pirate', hello: 'Ahoy' },
  { language: 'Pig Latin', hello: 'ello-hay' },
  { language: 'Morse Code', hello: '.... . .-.. .-.. ---' },
  { language: 'Braille', hello: '⠓⠑⠇⠇⠕' },
  ...
  { language: 'Bengali', hello: 'নমস্কার' },
  ...
  { language: 'Myanmar', hello: 'မင်္ဂလာပါ' },
  { language: 'Navajo', hello: "Yá'át'ééh" },
  ...
  { language: 'Tamil', hello: 'வணக்கம்' },
  { language: 'Telugu', hello: 'హలో' },
  { language: 'Thai', hello: 'สวัสดี' },
  { language: 'Toki Pona', hello: 'toki' },
  { language: 'Turkish', hello: 'Merhaba' },
  { language: 'Ukrainian', hello: 'Привіт' },
  ...
  { language: 'Yiddish', hello: 'שלום עליכם' },
