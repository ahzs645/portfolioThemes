...
export const PORTFOLIO_THEMES = [
  ...
  },
  {
    ...
    slug: 'chrome-desktop',
    name: 'Chrome Desktop',
    description: 'An ultra-quiet desktop-like landing page with embossed chrome typography, corner metadata, and a floating action dock inspired by chrispramana.com.',
    source: 'https://chrispramana.com',
    Component: lazyTheme(() => import('./ChrisPramana/ChrisPramanaTheme'), 'ChrisPramanaTheme'),
  },
  {
    id: 'jack-hogan',
    slug: 'dot-grid-scholar',
    name: 'Dot Grid Scholar',
    description: 'A dense personal homepage with a giant serif identity rail, crisp section navigation, and a soft luminous dot grid inspired by jackhogan.me.',
    source: 'https://www.jackhogan.me',
    Component: lazyTheme(() => import('./JackHogan/JackHoganTheme'), 'JackHoganTheme'),
  },
  {
    id: 'mek-gallery',
    slug: 'mek-index',
    name: 'MEK Index',
    description: 'A warm pixel-editorial portfolio with tabbed navigation, bordered archive cells, typographic project titles, and bold color fields inspired by MEK.txt.',
    source: 'https://www.mek.gallery',
    Component: lazyTheme(() => import('./MekGallery/MekGalleryTheme'), 'MekGalleryTheme'),
  },
  {
    id: 'brutalist',
    slug: 'brutalist',
  ...
  },
  {
    ...
    slug: 'milligram',
    name: 'Milligram',
    description: 'Ultra-minimal milligram-framework site in light-weight Roboto grey: a quiet "Hi" paragraph of inline purple links, plus publications and full-resume sub pages mirroring cpdomina.net\'s two-page structure.',
  ...
  },
  {
    ...
    slug: 'built-things',
    name: 'Built Things',
    description: 'A full-screen monogrid WebGL background with a fixed black lower-left panel, arrow-bulleted built-things list, and compact outbound link row, inspired by kieran.computer.',
