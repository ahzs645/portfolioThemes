...
export default class World {
  ...
  dispose() {
    if (this.arcadeScreen?.removeEventListeners) this.arcadeScreen.removeEventListeners();
    if (this.leftMonitorScreen?.removeEventListeners) this.leftMonitorScreen.removeEventListeners();
    if (this.rightMonitorScreen?.removeEventListeners) this.rightMonitorScreen.removeEventListeners();
    if (this.whiteboard?.removeEventListeners) this.whiteboard.removeEventListeners();
    if (this.rubiksCube?.removeEventListeners) this.rubiksCube.removeEventListeners();
    if (this.audioManager?.dispose) this.audioManager.dispose();
  }
}
