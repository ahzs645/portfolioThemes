...
export default class Resources extends EventEmitter {
  ...
  constructor() {
    ...
    this.loadingScreen = this.experience.query(".loadingScreen");
    this.audioButton = this.experience.query(".audio-button");
  ...
  setLoaders() {
    ...
    basisLoader.setTranscoderPath(withBase("comp/basis/"));
