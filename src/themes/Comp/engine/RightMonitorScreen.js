...
import { buildProjectsScreen } from "./cvScreens.js";
...
export default class RightMonitorScreen {
  ...
  setRightMonitorScreen() {
    ...
    if (this.experience.rightMonitorUrl) {
      const iframe = document.createElement("iframe");
      iframe.src = this.experience.rightMonitorUrl;
      ...
      container.id = "right-monitor-screen";
      const cvContent = buildProjectsScreen(this.experience.cv, {
        width: this.screenMonitorSize.width,
        height: this.screenMonitorSize.height,
      });
      container.appendChild(cvContent);
    }
