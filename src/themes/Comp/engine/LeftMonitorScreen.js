...
import { buildAboutScreen } from "./cvScreens.js";
...
export default class LeftMonitorScreen {
  ...
  setLeftMonitorScreen() {
    ...
    if (this.experience.leftMonitorUrl) {
      const iframe = document.createElement("iframe");
      iframe.src = this.experience.leftMonitorUrl;
      ...
      container.id = "left-monitor-screen";
      const cvContent = buildAboutScreen(this.experience.cv, {
