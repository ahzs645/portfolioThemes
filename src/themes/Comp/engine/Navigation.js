...
export default class Navigation {
  constructor() {
    ...
    this.bannerLinks = this.experience.queryAll(".banner-link");
    this.backButton = this.experience.query("#back-button");
    this.whiteboardButons = this.experience.query("#whiteboard-buttons");
    this.banner = this.experience.query(".banner");
    this.rubikMessage = this.experience.query(".rubik-message");
  ...
  onMouseMove = (e) => {
    const rect = this.webglElement.getBoundingClientRect();
  ...
  flyToPosition = (key) => {
    ...
    switch (key) {
      ...
      case "rubikGroup":
        ...
        break;
      case "linkedin":
        window.open(this.experience.socialUrls.linkedin || LINKEDIN_URL);
        break;
      case "github":
        window.open(this.experience.socialUrls.github || GITHUB_URL);
        break;
      case "itchio":
        window.open(this.experience.socialUrls.itchio || ITCHIO_URL);
        break;
    }
  };
