      ...
      <Content>
        ...
        <Header>
          ...
          <SocialRow>
            ...
            {phone && (
              <SocialLink $darkMode={darkMode} href={`tel:${phone}`} aria-label="Phone">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
        ...
        {professionalDevelopment?.length > 0 && (
          <Section>
            <SectionTitle $darkMode={darkMode}>Professional Development</SectionTitle>
            <WorkList>
              {professionalDevelopment.map((item, idx) => (
                <WorkItem key={`profdev-${idx}`}>
                  <WorkIcon $darkMode={darkMode} $variant="education">{item.name?.charAt(0) || 'P'}</WorkIcon>
                  <WorkInfo>
                    <WorkCompany $darkMode={darkMode}>{item.name}</WorkCompany>
                    <WorkRole $darkMode={darkMode}>{item.summary}</WorkRole>
                  </WorkInfo>
                  <WorkDate $darkMode={darkMode}>{item.date}</WorkDate>
                </WorkItem>
              ))}
            </WorkList>
          </Section>
